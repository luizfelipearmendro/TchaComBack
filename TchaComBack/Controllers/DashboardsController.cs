...
namespace TchaComBack.Controllers
{
    public class DashboardsController : Controller
    {
        ...
        public DashboardsController(ApplicationDbContext db, IMemoryCache cache)
        {
            _db = db;
            _cache = cache;
        }
        ...
        private void GraficoFuncionarios(DashboardsViewModel viewModel)
        {
            var idUsuario = HttpContext.Session.GetInt32("idUsuario");
        ...
        private void GraficoSetores(DashboardsViewModel viewModel)
        {
            var idUsuario = HttpContext.Session.GetInt32("idUsuario");
            if (idUsuario == null) return;
        ...
        private void GraficoUsuarios(DashboardsViewModel viewModel)
        {
            var idUsuario = HttpContext.Session.GetInt32("idUsuario");
            if (idUsuario == null) return;
        ...
        private void GraficoQuantidadeFuncionariosPorSexo(DashboardsViewModel viewModel)
        {
            var idUsuario = HttpContext.Session.GetInt32("idUsuario");
        ...
        private void GraficoSetoresComMaiotQuantidadeDeFuncionarios(DashboardsViewModel viewModel)
        {
            var idUsuario = HttpContext.Session.GetInt32("idUsuario");
            if (idUsuario == null) return;
